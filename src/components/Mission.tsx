    ...
    <section id="mission" className="py-20 px-6 bg-gray-900/20">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-block bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-2xl p-6">
            <p className="text-emerald-400 font-light">
              "Leveling the playing field, one trade at a time."
            </p>
          </div>
        </div>
      </div>
